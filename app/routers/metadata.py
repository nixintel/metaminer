...
async def search_metadata(
    ...
    matched_filter_id: Annotated[int | None, Query(description="Only entries that matched this filter id")] = None,
    matched_group_id: Annotated[int | None, Query(description="Only entries that matched any member of this filter group id")] = None,
